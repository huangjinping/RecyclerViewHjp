...
public class EventRxBus {
    ...
    public static synchronized EventRxBus getInstance() {
        if (null == instance) {
     ...
     * @return
     */
    public EventRxBus OnEvent(Observable<?> mObservable, Action1<Object> mAction1) {
     ...
     */
    @SuppressWarnings("rawtypes")
    public EventRxBus unregister(@NonNull Object tag,
